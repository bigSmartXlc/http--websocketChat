...
import { k as hasProtocol, m as isScriptProtocol, l as joinURL, w as withQuery, n as sanitizeStatusCode, o as getContext, p as createHooks, q as executeAsync, h as createError$1, v as withBase, d as destr, x as toRouteMatcher, y as createRouter$1, z as defu } from '../_/nitro.mjs';
...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-B9OTs2fr.mjs');
...
const unhead_7Cj8869iovzP8p54ujX1A_DQ_24ZKrgQp2irpyyYv5g = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DNy_ovKK.mjs')
  },
  {
    name: "socket",
    path: "/socket",
    component: () => import('./socket-qTSRZmCW.mjs')
  }
];
...
const revive_payload_server_W_T332r0O1qP_RgEGpogljEjBfOBEOJiRTMcqCY30Aw = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_7Cj8869iovzP8p54ujX1A_DQ_24ZKrgQp2irpyyYv5g,
  plugin,
  revive_payload_server_W_T332r0O1qP_RgEGpogljEjBfOBEOJiRTMcqCY30Aw,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-container" }, _attrs))} data-v-4801be30><header class="app-header" data-v-4801be30><h1 data-v-4801be30>AI小助手</h1><nav data-v-4801be30>`);
  ...
  _push(ssrRenderComponent(_component_router_link, { to: "/socket" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`WebSocket聊天`);
      } else {
        return [
          createTextVNode("WebSocket聊天")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</nav></header><main class="app-main" data-v-4801be30>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4801be30"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Btq7xckM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-0KCAikMz.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.2_@parcel+watcher_cef26f76380f98f76b1a19368fc0cc97/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.2_@parcel+watcher_cef26f76380f98f76b1a19368fc0cc97/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, br as d, entry$1 as default, navigateTo as n, qn as q, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
