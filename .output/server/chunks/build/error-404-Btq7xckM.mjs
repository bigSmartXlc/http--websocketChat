...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-6c6b432e><div class="fixed left-0 right-0 spotlight z-10" data-v-6c6b432e></div><div class="max-w-520px text-center z-20" data-v-6c6b432e><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-6c6b432e>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-6c6b432e>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-6c6b432e>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.2_@parcel+watcher_cef26f76380f98f76b1a19368fc0cc97/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c6b432e"]]);

export { error404 as default };
//# sourceMappingURL=error-404-Btq7xckM.mjs.map
